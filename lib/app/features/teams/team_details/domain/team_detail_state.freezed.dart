...
mixin _$TeamDetailState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(
            List<Players>? players, List<TeamMatches>? matches)
        loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<Players>? players, List<TeamMatches>? matches)?
        loaded,
...
abstract class _$$LoadedCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Players>? players, List<TeamMatches>? matches});
}
...
class _$Loaded implements Loaded {
  const _$Loaded(
      {final List<Players>? players, final List<TeamMatches>? matches})
      : _players = players,
        _matches = matches;
