...
import 'package:dota_online/features/players/pro_players_list/presentation/widgets/players_list_with_search_body.dart';
      ...
      body: BlocBuilder<ProPlayersListCubit, ProPlayersListState>(
        builder: (context, state) {
          return state.map(
            ...
            loaded: (value) => PlayersListWithSearchBody(
